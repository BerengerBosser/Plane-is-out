...
export const GEAR = {
  ...
  // vêtements : haut
  c_tee: { name: 'Tenue de base', w: 2, h: 2, wear: 'top', grid: [3, 2], base: true, icon: ICONS.tee, look: { kind: 'base' }, desc: 'Quelques poches.' },
  c_jeanshirt: { name: 'Chemise en jean', w: 2, h: 2, wear: 'top', grid: [4, 2], icon: ICONS.tee, look: { kind: 'shirt', col: '#4a6a9a', sleeve: '#4a6a9a', cuff: '#3a5580' }, desc: 'Poches de poitrine.' },
  c_raincoat: { name: 'Ciré de pêcheur', w: 2, h: 2, wear: 'top', grid: [4, 3], icon: ICONS.jacket, look: { kind: 'coat', col: '#f2c230', sleeve: '#f2c230', cuff: '#d9a51c' }, desc: 'Grandes poches étanches.' },
  c_pilot: { name: 'Blouson d\'aviateur', w: 2, h: 2, wear: 'top', grid: [4, 3], icon: ICONS.jacket, look: { kind: 'jacket', col: '#7a4a2c', sleeve: '#7a4a2c', cuff: '#e9dcc0', collar: '#e9dcc0' }, desc: 'Cuir épais, doublure en mouton.' },
  c_miljacket: { name: 'Veste militaire', w: 2, h: 2, wear: 'top', grid: [5, 3], armor: 0.08, icon: ICONS.jacket, look: { kind: 'jacket', col: '#5a6a3a', sleeve: '#5a6a3a', cuff: '#4a5a2e', collar: '#4a5a2e' }, desc: 'Renforcée. −8 % de dégâts.' },
  // bas
  c_pants: { name: 'Pantalon de toile', w: 2, h: 2, wear: 'bottom', grid: [3, 2], base: true, icon: ICONS.pants, look: { kind: 'base' }, desc: 'Quelques poches.' },
  c_jeans: { name: 'Jean', w: 2, h: 2, wear: 'bottom', grid: [4, 2], icon: ICONS.pants, look: { col: '#3a4f7a' }, desc: 'Solide.' },
  c_cargo: { name: 'Pantalon cargo', w: 2, h: 2, wear: 'bottom', grid: [4, 3], icon: ICONS.pants, look: { col: '#8a7a55', pockets: true }, desc: 'Poches sur les cuisses.' },
  c_milpants: { name: 'Treillis militaire', w: 2, h: 2, wear: 'bottom', grid: [5, 3], armor: 0.05, icon: ICONS.pants, look: { col: '#5a6a3a', pockets: true }, desc: 'Renforcé. −5 % de dégâts.' },
  // gilets
  c_lifevest: { name: 'Gilet de sauvetage', w: 2, h: 2, wear: 'vest', grid: [2, 2], swim: 1.6, icon: ICONS.lifevest, look: { kind: 'life', col: '#ff7a2a' }, desc: 'Nage bien plus vite.' },
  c_armorvest: { name: 'Gilet renforcé', w: 2, h: 2, wear: 'vest', grid: [3, 2], armor: 0.3, icon: ICONS.vest, look: { kind: 'armor', col: '#3a4450' }, desc: '−30 % de dégâts.' },
  c_tacvest: { name: 'Gilet tactique', w: 2, h: 2, wear: 'vest', grid: [4, 3], armor: 0.22, icon: ICONS.vest, look: { kind: 'tac', col: '#4a5a32' }, desc: 'Porte-chargeurs. −22 % de dégâts.' },
  // sacs
  c_satchel: { name: 'Sacoche', w: 2, h: 2, wear: 'back', grid: [4, 4], icon: ICONS.pack, look: { size: 0.7, col: '#8a5a3a' }, desc: 'Petite besace en cuir.' },
  c_backpack: { name: 'Sac à dos', w: 2, h: 2, wear: 'back', grid: [5, 5], icon: ICONS.pack, look: { size: 1, col: '#c84a3a' }, desc: 'Sac de voyage.' },
  c_hiking: { name: 'Sac de randonnée', w: 3, h: 3, wear: 'back', grid: [6, 6], icon: ICONS.pack, look: { size: 1.3, col: '#2f6a8a', roll: true }, desc: 'Grand volume.' },
  c_milpack: { name: 'Sac militaire', w: 3, h: 3, wear: 'back', grid: [6, 8], icon: ICONS.pack, look: { size: 1.45, col: '#5a6a3a', roll: true }, desc: 'Le plus grand sac de l\'archipel.' },
  // chapeaux
